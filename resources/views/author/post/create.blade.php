...
<div class="card-body">
    <div class="container-fluid">
        <h4 class="card-title"><strong>Add New Post</strong><span style="margin-left: 10px;" class="badge badge-danger">{{-- {{ $tag->count() }} --}}</span> <a href="{{ route('author.post.index') }}" class="btn btn-warning btn-sm" style="float: right;"><i class="fa fa-check"></i> Back</a></h4>
      </div>
    <form action="{{ route('author.post.store') }}" method="post" enctype="multipart/form-data">
      @csrf
        ...
        <div class="form-row">
            ...
            <div class="col-md-12 mb-3 ">
               ...
               <div class="form-group">
                    <textarea class="textarea_editor form-control @error('body') is-invalid @enderror" rows="10" placeholder="Enter text ..." name="body">{{ old('body') }}</textarea>
        ...
        <div class="form-group">
            <div>
              <input class="form-check-input" type="checkbox" value="1" id="invalidCheck2" name="p_status">
