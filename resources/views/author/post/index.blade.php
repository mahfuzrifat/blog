 ...
 <div class="row">
    <div class="col-12">
    	 <div class="card">
            <div class="card-body">
                <div class="container">
                    <h4 class="card-title"><strong>Post Table</strong><span style="margin-left: 10px;" class="badge badge-danger">{{ $post->count() }}</span> <a href="{{ route('author.post.create') }}" class="btn btn-success " style="float: right;"><i class="fa fa-plus"></i> Add new Post</a></h4> 
                </div>
                <div class="table-responsive m-t-40">
                    <table id="myTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <td> 
                                <a href="{{ route('author.post.edit',$row->id) }}" class="btn btn-sm btn-info"> Edit</a>
                                 <a href="{{ route('author.post.show',$row->id) }}" class="btn btn-sm btn-warning">View</a>
                                <a href="{{ route('author.post.destroy',$row->id) }}" class="btn btn-sm btn-danger" id="delete" > Delete</a> 
                            </td> 
