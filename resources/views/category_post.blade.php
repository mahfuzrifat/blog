...
@push('css')
    ...
    <style>
         .slider-bg{
            height: 50%;
            width: 100%;
             background-image: url({{ Storage::disk('public')->url('category/'.$category->photo) }});
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card h-100">
                                <div class="single-post post-style-1">
                                    ...
                                    <a class="avatar" href="{{route('author.profile',$row->user->user_name)}}"><img
                 ...
                 @else
                    <div class="col-lg-12 col-md-6">
                        <div class="card h-50">
                            <div class="single-post post-style-1">
                                <div class="blog-info">
                                    <h4 class="title"><strong>opppsss !!  Didn't find any post for this category  :
                                            (</strong> </h4>
                                </div><!-- blog-info -->
                            </div><!-- single-post -->
