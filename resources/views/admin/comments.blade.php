 ...
 <div class="row">
    <div class="col-12">
    	 <div class="card">
            <div class="card-body">
                <div class="container">
                    <h4 class="card-title"><strong>Comments Table</strong><span style="margin-left: 10px;" class="badge
                    badge-danger">{{ $comments->count() }}</span> </h4>
                </div>
                    ...
                    <table id="myTable" class="table table-bordered table-striped">
                        ...
                        @foreach($comments as $key=>$comment)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.comment.destroy',$comment->id)}}" class="btn btn-sm btn-danger"
                                       id="delete" > Delete</a>
                                </td>
